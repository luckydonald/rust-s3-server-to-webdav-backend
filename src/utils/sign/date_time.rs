...
pub fn truncate_subsecs(time: SystemTime) -> SystemTime {
...
pub mod test_parsers {
    ...
    pub fn parse_date_time(date_time_str: &str) -> Result<SystemTime, ParseError> {
    ...
    pub fn parse_date(date_str: &str) -> Result<SystemTime, ParseError> {
