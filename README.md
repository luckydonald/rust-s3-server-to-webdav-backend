# rust-s3-server-to-webdav-backend
An simple S3 compatible Object Storage written in Rust, which will store the files in a connected WebDAV.

This is based on https://github.com/wushilin/rust-s3-server, with the original readme below:
